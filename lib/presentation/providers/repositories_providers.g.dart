...
final hotlineMiamiModsRepositoryProvider =
    AutoDisposeProvider<HotlineMiamiModsRepository>.internal(
      hotlineMiamiModsRepository,
      name: r'hotlineMiamiModsRepositoryProvider',
      debugGetCreateSourceHash:
          const bool.fromEnvironment('dart.vm.product')
              ? null
              : _$hotlineMiamiModsRepositoryHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
final projectConfigurationRepositoryProvider =
    AutoDisposeProvider<ProjectConfigurationRepository>.internal(
      projectConfigurationRepository,
      name: r'projectConfigurationRepositoryProvider',
      debugGetCreateSourceHash:
          const bool.fromEnvironment('dart.vm.product')
              ? null
              : _$projectConfigurationRepositoryHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
