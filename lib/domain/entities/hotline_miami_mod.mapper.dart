...
class HotlineMiamiModMapper extends ClassMapperBase<HotlineMiamiMod> {
  ...
  static const Field<HotlineMiamiMod, ModAuthor> _f$author = Field(
    'author',
    _$author,
  );
  static ModCover? _$cover(HotlineMiamiMod v) => v.cover;
  static const Field<HotlineMiamiMod, ModCover> _f$cover = Field(
    'cover',
    _$cover,
  );
  ...
  static const Field<HotlineMiamiMod, ModDirectory> _f$directory = Field(
    'directory',
    _$directory,
  );
  ...
  _f$additionalFilesDirectory = Field(
    'additionalFilesDirectory',
    _$additionalFilesDirectory,
  );
  static IList<ModFile> _$files(HotlineMiamiMod v) => v.files;
  static const Field<HotlineMiamiMod, IList<ModFile>> _f$files = Field(
    'files',
    _$files,
    opt: true,
    def: const IList.empty(),
  );
  static ModMusic? _$music(HotlineMiamiMod v) => v.music;
  static const Field<HotlineMiamiMod, ModMusic> _f$music = Field(
    'music',
    _$music,
    opt: true,
  );
...
mixin HotlineMiamiModMappable {
  ...
  get copyWith =>
      _HotlineMiamiModCopyWithImpl<HotlineMiamiMod, HotlineMiamiMod>(
        this as HotlineMiamiMod,
        $identity,
        $identity,
      );
  @override
  bool operator ==(Object other) {
    return HotlineMiamiModMapper.ensureInitialized().equalsValue(
      this as HotlineMiamiMod,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return HotlineMiamiModMapper.ensureInitialized().hashValue(
      this as HotlineMiamiMod,
    );
  }
}
...
extension HotlineMiamiModValueCopy<$R, $Out>
  ...
  HotlineMiamiModCopyWith<$R, HotlineMiamiMod, $Out> get $asHotlineMiamiMod =>
      $base.as((v, t, t2) => _HotlineMiamiModCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _HotlineMiamiModCopyWithImpl<$R, $Out>
  ...
  HotlineMiamiModCopyWith<$R2, HotlineMiamiMod, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _HotlineMiamiModCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
